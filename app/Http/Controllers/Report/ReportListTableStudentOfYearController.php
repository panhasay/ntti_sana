...
class ReportListTableStudentOfYearController extends Controller
{
    public $services;
    public  $page;
    ...
    public function index()
    {
        ...
        try {
            ...
            ->get()
            ->groupBy(['qualification', 'apply_year']);

            // dd($records);

            return view('reports.report_list_table_student_of_years', compact('records', 'department','type'));	
        } catch (\Exception $ex) {
            DB::rollBack();
