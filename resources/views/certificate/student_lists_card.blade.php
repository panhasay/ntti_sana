...
<link href="https://fonts.googleapis.com/css2?family=Battambang:wght@100;300;400;700;900&family=Moul&display=swap"
    rel="stylesheet">
...
<div class="row align-items-start">
    ...
    <div class="col-12 text-center  title" style="font-family: 'Moul' !important;">
        គំរូ បញ្ចីឈ្មោះនិស្សឹតធ្វើកាត ក្រុម<span class="bold"> : {{ $header->code ?? '' }}
        </span>វេន{{ $header->section->name_2 ?? '' }} ជំនាញ{{ $header->skill->name_2 ?? '' }} ឆ្នាំសិក្សា ២០២៤-២០២៥
    </div>
</div>
<br>
        ...
        @foreach ($records as $line)
            ...
            <tr class="general-print">
                ...
                <td class="text-center">
                    <img src="{{ asset($pictues && $pictues->picture_ori ? '/uploads/student/' . $pictues->picture_ori : '/asset/NTTI/images/faces/default_User.jpg') }}"
