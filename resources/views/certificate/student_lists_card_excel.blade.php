@if (count($records) > 0)
    ...
    <table>
        <tr>
            ...
            <th style="font-weight: 700; font-family: Moul, serif !important;" colspan="6">ព្រះរាជាណាចក្រកម្ពុជា <br>
                ជាតិ សាសនា ព្រះមហាក្សត</th>
        </tr>
        <tr>
        ...
        <tr>
            <th style="font-weight: 700; font-family: Moul, serif !important;" colspan="8">
                <div class="col-12 text-center  title" style="font-family: 'Moul' !important;">
                    ...
                    </span>វេន{{ $header->section->name_2 ?? '' }} ជំនាញ{{ $header->skill->name_2 ?? '' }} ឆ្នាំសិក្សា
                    ២០២៤-២០២៥
                </div>
            </th>
        </tr>
