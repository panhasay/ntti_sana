    ...
    @foreach ($record_students as $record)
        <div class="mx-auto relative page-break">
            <div class="flex justify-between items-start w-full max-w-5xl mx-auto">
                ...
                <div class="w-fit text-center mt-15 pl-8">
                    ...
                    <p class="ref battambang-regular">លេខ:
                        {{ $record->certStatus?->reference_code ?? '........................ វ.ជ.ប.ប' }}</p>
                    <div>
            ...
            <div class="mt-6 text-center">
                ...
                <h2 class="text-base font-semibold tracking-wide uppercase time-roman-bold">Certification Of Student
                    Status
                </h2>
            </div>
                ...
                <div class="grid grid-cols-2 gap-8 mt-4 text-base">
                    ...
                    <div class="space-y-1 time-roman-regular">
                        <div class="flex flex-wrap">
                            <span>Name:</span>
                            <span class="font-semibold pl-2">{{ $record->name }}</span>

                            <span class="ml-auto">Sex:</span>
                            <span class="font-semibold pl-2">{{ $record->gender == 'ស្រី' ? 'Female' : 'Male' }}</span>
                        </div>
                        <div class="flex">
                            <span>Date of Birth:</span>
                            <span
                                class="font-semibold pl-2">{{ \Carbon\Carbon::parse($record->date_of_birth)->format('j/M/Y') }}</span>
                        </div>
                        <div class="flex">
                            <span>Place of Birth:</span>
                            <span class="font-semibold pl-2">{{ $record->guardian_address ?? 'N/A' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1 battambang-regular">
                        <div class="flex">
                            ...
                            <span class="font-semibold pl-2">{{ $record->name_2 }}</span>

                            <span class="ml-auto">ភេទ៖</span>
                            <span class="font-semibold pl-2">{{ $record->gender }}</span>
                        </div>
                        <div class="flex">
