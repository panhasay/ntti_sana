        ...
        <div>
            <header>
                ...
                <div class="ministry">
                    ...
                    <p class="ref">Ref: {{ $record->certTranscript?->reference_code ?? '...OS/24... NTTI/IT' }}</p>
                </div>
            </header>
            ...
            <table class="info" style="font-family: 'Times New Roman';">
                <tr>
                    <td><strong>Record of :</strong> {{ $record->name }}</td>
                    <td><strong>Sex :</strong> {{ $record->gender == 'ស្រី' ? 'Female' : 'Male' }}</td>
                </tr>
                <tr>
                    <td><strong>Degree&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong>
                        {{ $record->fullname ?? '' }}</td>
                    <td><strong>Date of Birth :</strong>
                        {{ \Carbon\Carbon::parse($record->date_of_birth)->format('j/M/Y') }}</td>
                </tr>
            </table>
            ...
            <table class="info" border="1"
                ...
                <thead>
                    <tr>
                        <th rowspan="2" width="30"
                            ...
                            YEAR</th>
                        <th colspan="2"
                            style="border: 1px solid black; padding: 5px; text-align: center;width: 50%;">
                            SEMESTER I</th>
                        <th colspan="2"
                            style="border: 1px solid black; padding: 5px; text-align: center;width: 50%;">
                            SEMESTER II</th>
                ...
                <tbody>
                    ...
                    @foreach ($record->groupedSubjects as $year => $semesters)
                        @php
                        ...
                        @for ($i = 0; $i < $maxRows; $i++)
                            <tr>
                                ...
                                <td class="score-td">
                                    {{ isset($semester1[$i]) ? number_format($semester1[$i]->score, 2) : '' }}
                                </td>

                                {{-- Semester II --}}
                                <td style="padding: 5px;">{{ $semester2[$i]->sub_eng ?? '' }}</td>
                                <td class="score-td">
                                    {{ isset($semester2[$i]) ? number_format($semester2[$i]->score, 2) : '' }}
                                </td>
                            </tr>
                        @endfor
                ...
                <table class="remark-title">
                    <tr>
                        ...
                        <td style="text-align: right; font-weight: bold;">
                            Phnom Penh, Date:
                            {{ $record->certTranscript == null ? '.................' : \Carbon\Carbon::parse($record->certTranscript?->print_date)->format('j/M/Y') }}
                        </td>
                    </tr>
                </table>
            ...
            <htmlpagefooter name="myFooter">
                <div style="text-align: center; font-size: 5.5pt; line-height: 1.3;">
                    ...
                    National Technical Training Institute (NTTI), Russian Federation Blvd, Teuk Thlar, Sen Sok, Phnom
                    Penh,
                    Cambodia
