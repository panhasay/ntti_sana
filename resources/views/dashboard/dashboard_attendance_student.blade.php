...
@section('content')
<div class="ma-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
    ...
    <div class="filter-controls mb-6">
        <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            <!-- Date Navigation -->
            <div
                class="date-navigation w-full sm:w-auto flex items-center bg-white rounded-lg border border-gray-300 overflow-hidden">
                <button type="button" onclick="navigateDate('prev')"
                    class="nav-button p-2.5 hover:bg-gray-100 transition-colors">
                ...
                <div class="relative flex-1 border-x border-gray-200">
                    ...
                    <input datepicker datepicker-format="dd/mm/yyyy" type="text" id="date-filter"
                ...
                <button type="button" onclick="navigateDate('next')"
                    class="nav-button p-2.5 hover:bg-gray-100 transition-colors">
                    <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="filter-selects flex items-center gap-4 flex-1">
                <div class="flex items-center gap-2 w-full sm:w-auto">
                    <label for="department-filter"
                        class="text-sm font-medium text-gray-700 whitespace-nowrap khmer-font">ដេប៉ាតឺម៉ង់៖</label>
                    <select id="department-filter"
                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        <option value="All Departments" {{ $selectedDepartment=='All Departments' ? 'selected' : '' }}>
                            ដេប៉ាតឺម៉ង់ទាំងអស់</option>
                ...
                <div class="flex items-center gap-2 w-full sm:w-auto">
                    <label for="section-filter"
                        class="text-sm font-medium text-gray-700 whitespace-nowrap khmer-font">វេន៖</label>
            ...
            <div class="p-4 sm:p-6 flex flex-col h-full">
                ...
                <div class="flex items-center space-x-3 sm:space-x-4 mb-4">
                    <span class="relative flex h-10 sm:h-12 w-10 sm:w-12 shrink-0 overflow-hidden rounded-full">
                        <span
                            class="flex h-full w-full items-center justify-center rounded-full avatar-bg-{{ (crc32($item['teacher']) % 5) + 1 }}">
                    ...
                    <div class="flex-1">
                        <h3 class="text-base sm:text-lg font-semibold leading-none tracking-tight mb-1.5">{{
                            $item['teacher'] }}</h3>
