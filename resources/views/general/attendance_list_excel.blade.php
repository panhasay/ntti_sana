...
<body>
    <table>
        <thead>
            <tr>
                <th colspan="11" style="font-family: 'Khmer OS Muol Light'; text-align: right;">
                    ព្រះរាជាណាចក្រកម្ពុជា
                </th>
            </tr>
            <tr>
                <th colspan="11" style="font-family: 'Khmer OS Muol Light'; text-align: right;">ជាតិ សាសនា ព្រះមហាក្សត្រ
                </th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                @endphp
                <th colspan="12" style="font-family: 'Khmer OS Muol Light'; text-align: center;">
                    បញ្ជីសរុបវត្តមានប្រចាំឆមាសទី
                    {{ \App\Service\Service::convertToKhmerNumber($firstRecord->semester) ?? '' }} ឆ្នាំទី
                    {{ \App\Service\Service::convertToKhmerNumber($firstRecord->years) ?? '' }}
                </th>
            </tr>
            <tr>
                <th colspan="12" style="font-family: 'Khmer OS Muol Light'; text-align: center;">
                    ថ្នាក់៖ {{ $records->first()->qualification ?? '' }}
                    ជំនាញ៖ {{ $firstRecord->skill_name ?? '' }}
            ...
            <tr>
                <th colspan="12" style="font-family: 'Khmer OS Muol Light'; text-align: center;">
                    ឆ្នាំសិក្សា៖
                    {{ \App\Service\Service::formatSessionYearToKhmer($firstRecord->session_year_code ?? '') }}
                </th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                @endforeach
                <th width='15'
                    style="font-family: 'Khmer OS Battambang'; text-align: center;border: 1px solid black;">
                    ឥ.ច</th>
                <th width='15'
                    style="font-family: 'Khmer OS Battambang'; text-align: center;border: 1px solid black;">
                    ម.ច</th>
        ...
        <tbody>
            @foreach ($uniqueStudents as $index => $student)
                @php
                    $monthly = $records->where('student_code', $student->student_code);
                    $total_absent = 0;
                    $total_permission = 0;
                @endphp
                <tr>
                    ...
                    @foreach ($attendanceMonths as $month)
                        ...
                        <td style="border: 1px solid black; text-align: center;">{{ $permission }}</td>
                    @endforeach
                    <td style="border: 1px solid black; text-align: center;">{{ $total_absent }}</td>
                    <td style="border: 1px solid black; text-align: center;">{{ $total_permission }}</td>
                </tr>
            @endforeach
            <tr>
            ...
            <tr>
                <td colspan="11" style="font-family: 'Khmer OS Battambang';text-align:right;">
                    {{ App\Service\service::updateDateTime() }}
                </td>
            </tr>
            <tr>
                <th colspan="10" style="font-family: 'Khmer OS Muol Light';text-align:right;">
                    អ្នកធ្វើតារាង
                </th>
            </tr>
            <tr>
                <th colspan="12" style="font-family: 'Khmer OS Battambang';;text-align:center;">
            ...
            <tr>
                <th colspan="4" style="font-family: 'Khmer OS Battambang';text-align:center;">
                    បានឃើញ​ និងឯកភាព
                </th>
            </tr>
            <tr>
