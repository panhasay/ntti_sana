...
@section('content')
            ...
            <div class="col-12 col-md-6 order-md-1 order-last">
                <div class="title-page">
                    ...
                    តារាងវត្តមានប្រចាំខែ {{ App\Service\service::getMonthKhmer($month - 1) }} ក្រុម <span
                        class="font-class">{{ $classInfo->class_code ?? '' }}</span>
                ...
                <div class="header-left">
                    <button type="button"
                        class="btn btn-outline-info btn-icon-text btn-sm mb-2 mb-md-0 me-2 prints-att-monthly "
    ...
    <div class="table-responsive mb-5">
        <table class="table" id="table1">
            ...
            <tbody>
                @include('general.attendance_monthly_record')
            </tbody>
        </table>
    </div>
    <iframe id="printFrame" style="display:none;"></iframe>
    <script>
        $(document).on('click', '.prints-att-monthly', function() {
