    ...
    @if ($is_print ?? '' == 'Yes')
        ...
        <div class="row">
            <div class="col-12 text-center moul-regular">
                ...
                ឆ្នាំទី​{{ \App\Service\Service::convertToKhmerNumerals((int) $firstRecord->years) }}
            </div>
        </div>
        ...
        <div class="row">
            <table class="table table-bordered table-print mt-2">
                <tbody id="recordsLineTableBody">
                    <tr>
                        <th rowspan="2" width="10" class="fw-bold text-center">ល.រ</th>
            ...
            <div class="row mt-3 text-center  battambang-bold">
