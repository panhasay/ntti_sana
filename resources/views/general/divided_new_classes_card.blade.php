    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-6">
            ...
            <span class="title-report">
                បន្ថែបពត៍មាននិស្សិតចូលថ្នាក់ {{ $records->code ?? '' }} សរុបចំនួន ​{{ count($record_sub_lines ?? '') }} នាក់
            </span>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-fullscreen" style="max-width: 100%;">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-dark" id="ModalStudnetRegister">ឈ្មោះនិស្សិតឆ្នាំទី១</h5>
