...
<div class="page-header flex-wrap">
  ...
  <div class="d-grid d-md-flex justify-content-md-end p-3">
    <input type="text" class="form-control mb-2 mb-md-0 me-2" id="search_data" data-page="student_registration_remaining" name="search_data"
    ...
    <form id="advance_search" role="form" class="form-horizontal" enctype="multipart/form-data" action="">
      <div class="row">
        <div class="col-md-12">
          ...
          <button type="button" class="btn btn-primary text-white" data-page="student_registration_remaining" id="btn-adSearch">Search</button>
        </div>
      </div>
    </form>
  </div>
...
@include('general.student_register_remaining_lists')
