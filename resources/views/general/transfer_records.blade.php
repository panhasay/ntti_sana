...
@foreach ($records as $record)
    ...
    ?>
    <tr id="row{{$record->student_code ?? ''}}" class="{{ $hang_of_student->student_code ?? '' == $record->student_code ? 'bg-warning text-white' : '' }} {{ $transfer->student_code ?? '' == $record->student_code ? 'bg-info text-white' : '' }}">
        <td class="">
            <div class="btn-group">
