...
@section('content')
<div class="title-report mt-3">របាយការណ៏ សរុបពិន្ទុប្រលង បរិញ្ញាបតនិង បរិញ្ញាបតរង</div>
<!--option--->
...
@include("system.option_advance_search_assign_classes")
...
@include('reports.report_total_score_exam_list')
...
<script>
  $(document).ready(function() {
    ...
    $(document).on('click', '#btn-priview', function() {
      ...
      $.ajax({
        type: "GET",
        url: '/report-total-score-priview?type=priview',
        data: data,
        beforeSend: function() {
          $('.loader').show();
        },
