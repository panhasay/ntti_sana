...
Route::group(['prefix' => 'certificate', 'middleware' => 'auth'], static function () {
    ...
    Route::get('/degree-temporary/{id}', [CertificateController::class, 'preview_print'])->name('degree-teporary');
    Route::get('/certificate/degree-temporary-multi', [CertificateController::class, 'previewPrintMulti']);
});
